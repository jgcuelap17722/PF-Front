...
export function getUserInfo(id, token) {
    const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/user/${id}`
    const options = {
        method: 'GET',
...
export function getCountries() {
    const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/countries`;
    return async function (dispatch) {
...
export function createNewUser(obj) {
    const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/user`;
    const options = {
        method: 'POST',
...
export function loginUser(obj) {
    const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/auth/userLogin`;
    const options = {
        method: 'POST',
        headers: { 'Content-Type': 'Application/json' },
        body: JSON.stringify(obj)
...
export function sendEmailConfirm(obj){
    const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/verify`;
    const options = {
        method: 'POST',
        headers: { 'Content-Type': 'Application/json' },
        body: JSON.stringify(obj)
...
export function emailConfirmed(tok){
	const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/verify/tk/${tok}`;
	return async function (dispatch) {
		return await fetch(url)
			.then(response => response.json())
			.then(data => {
...
export function pwReset(obj){
    const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/verify/recpass`;
    const options = {
        method: 'POST',
        headers: { 'Content-Type': 'Application/json' },
        body: JSON.stringify(obj)
...
export function pwChange(obj, tak){
    const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/verify/modpass/${tak}`;
    const options = {
        method: 'PUT',
        headers: { 'Content-Type': 'Application/json' },
        body: JSON.stringify(obj)
...
export function postPay(obj){
    const url = `${REACT_APP_TEST_BACK_URL}/api/v1.0/donations/urlPreferential`;
    const options = {
        method: 'POST',
        headers: {'Content-Type': 'Application/json'},
        body: JSON.stringify(obj),
